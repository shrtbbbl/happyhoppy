...
<body <?php body_class(); ?> <?php if(isset($pp_homepage_style) && !empty($pp_homepage_style)) { echo 'data-style="'.$pp_homepage_style.'"'; } ?>>
	...
	?>
	    ...
	    <div class="inner">
	    	...
	    	<h2 class="widgettitle">Sample Demos</h2>
	    	<ul class="demo_list">
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/cache/demos/vega_demo1.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Original</h6>
			    	    		<a href="http://themes.themegoods2.com/vega/" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/cache/demos/vega_demo2.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Minimal</h6>
			    	    		<a href="http://themes.themegoods2.com/vega/?vegastyle=2" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/cache/demos/vega_demo3.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Contrast</h6>
			    	    		<a href="http://themes.themegoods2.com/vega/?vegastyle=3" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>
	    		<li>
		    		<img src="<?php echo get_stylesheet_directory_uri(); ?>/cache/demos/vega_demo4.jpg" alt=""/>
		    		<div class="demo_thumb_hover_wrapper">
		    		    <div class="demo_thumb_hover_inner">
		    		    	<div class="demo_thumb_desc">
			    	    		<h6>Left Align Menu</h6>
			    	    		<a href="http://themes.themegoods2.com/vega/homepage-6-revslider/?vegastyle=4" target="_blank" class="button white">Launch</a>
		    		    	</div> 
		    		    </div>	   
		    		</div>		   
	    		</li>

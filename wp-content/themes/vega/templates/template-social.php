...
<div class="social_wrapper">
    <ul>
        ...
        <?php
    	    ...
    	    {
    	?>
    	<li class="behance"><a <?php if(!empty($pp_footer_social_link_blank)) { ?>target="_blank"<?php } ?> title="Behance" href="http://behance.net/<?php echo $pp_behance_username; ?>"><i class="fa fa-behance-square"></i></a></li>
    	<?php
    	    }
    	?>
    	<?php

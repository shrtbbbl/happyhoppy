...
jQuery(function($){
    	$.supersized({
    		...
    		?>
    		fit_portrait         	:   <?php echo $pp_full_fit_image; ?>,		//Portrait images will not exceed browser height
    		fit_landscape			:   <?php echo $pp_full_fit_image; ?>,		//Landscape images will not exceed browser width
    		fit_always				: 	<?php echo $pp_full_fit_image; ?>,
...
?>
<?php $homeslides .= '{image : \''.$image_url[0].'\', thumb: \''.$small_image_url[0].'\', title: \'<div id="gallery_caption"><h2>'.addslashes($image_caption).'</h2></div>\'},'; ?>
<?php
	}
?>

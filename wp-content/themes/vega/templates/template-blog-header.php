...
else
{
	if(is_archive() && !is_category() && !is_tag())
	{
		...
		?>
		<div id="page_caption" <?php if(!empty($pp_page_bg)) { ?> data-image="<?php echo esc_url($background_image); ?>" data-width="<?php echo esc_attr($background_image_width); ?>" data-height="<?php echo esc_attr($background_image_height); ?>" class="hasbg parallax"<?php } ?>>

...
{
	wp_enqueue_script("jquery.cycle2.min", get_stylesheet_directory_uri()."/js/jquery.cycle2.min.js", false, THEMEVERSION, true);
	wp_enqueue_script("custom_cycle", get_stylesheet_directory_uri()."/js/custom_cycle.js", false, THEMEVERSION, true);
}
?>
